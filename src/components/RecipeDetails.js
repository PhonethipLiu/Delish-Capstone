    ...
    <div>
      <Card className="Card-RecipeDetails">
        ...
        <CardLink onClick={props.clickEditButton}>Edit Recipe</CardLink>
          <CardLink onClick={props.deleteRecipe}className="text-right">Delete</CardLink>
        ...
        <CardImg width="100%" src={props.recipe.image} alt="Recipe Card image" />
        <CardBody>
          ...
          <CardImg className="Card-Snapshot" src={props.recipe.snapshot} alt="Recipe screencapture"/>
